node {
  ...
  stage('Create Docker Image') {
    dir('webapp') {
      ...
      sh label: '', script: "docker run --rm -u ${USER} -p 8080:8080 -v jenkins-data:/var/jenkins_home -v /var/run/docker.sock:/var/run/docker.sock  -v ${HOME}:/home  aa54035/docker-jenkins-pipeline:V11"
